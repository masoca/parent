...
import com.msc.test.springmvc.utils.JedisUtil;
...
public class RedisTest {
	...
	@Test
	public void testSortedSet()// 有序集合还有诸如zinterstore, zunionstore,
								// zremrangebyscore, zremrangebyrank, zrevrank,
								// zrevrange, zrangebyscore等命令。
	{
		jedis.flushDB();
